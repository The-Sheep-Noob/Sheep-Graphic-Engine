...
// GLEW/GLFW
#include <GLEW/glew.h>    // This example is using glew to access OpenGL functions (because it is small). You may use gl3w/glad/glLoadGen/etc. whatever already works for you.
